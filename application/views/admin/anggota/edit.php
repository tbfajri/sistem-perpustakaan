...
//form open
echo form_open(base_url('admin/anggota/edit/'.$anggota->id_anggota),' class="form-horizontal"');
?>

<div class="form-group">
    <label for="inputEmail3" class="col-md-2 control-label">Nama Anggota</label>
    <div class="col-md-5">
        <input type="text" class="form-control" name="nama_anggota" placeholder="Nama Anggota" value="<?php echo $anggota->nama ?>" required>
    </div>
</div>
